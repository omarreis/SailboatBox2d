...
uses
  ...
  USailboatTest    in '..\Sailboat\USailboatTest.pas',
  omSailboat       in '..\Sailboat\omSailboat.pas',
  omSailboatHelper in '..\Sailboat\omSailboatHelper.pas',
  uLiftDragCalculator in '..\Sailboat\uLiftDragCalculator.pas';
