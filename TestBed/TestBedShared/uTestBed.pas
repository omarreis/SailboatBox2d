...
begin
   ...
   begin
      ...
      begin
         ...
         else m_world.Step(timeStep, velocityIterations, positionIterations, True);
   ...
   begin
     ...
     begin
       ...
       NextLine; // space line
       DrawText(Format('bodies/contacts/joints = %d/%d/%d', [m_world.GetBodyCount, m_world.GetContactCount, m_world.GetJointCount]));
       DrawText(Format('proxies/height/balance/quality = %d/%d/%d/%f', [m_world.GetProxyCount, m_world.GetTreeHeight, m_world.GetTreeBalance, m_world.GetTreeQuality]));
       NextLine; // space line
